          ...
          <div class="chart-box">
            ...
            <table class="table table-responsive">
              ...
              <tr>
                <?php 
                $no = 1;
                $get_data = mysqli_query($conn, "select * from admin");
                ...
                <!-- <td class="text-truncate">
                    <a href='edit_data_training.php?GetID=<?php echo $id ?>' style="text-decoration: none; list-style: none;"><input type='submit' value='Edit' id='editbtn' class="btn btn-primary btn-user" ></a>
                    <a href='delete_data_training.php?Del=<?php echo $id ?>' style="text-decoration: none; list-style: none;"><input type='submit' value='Delete' id='delbtn' class="btn btn-primary btn-user" ></a>                       
                </td> -->
              </tr>
              <?php
              $no++;
