...
$id_data = $_GET['GetID'];
$query = mysqli_query($conn, "SELECT * FROM penjualan WHERE id_penjualan = '".$id_data."'");
                            ...
                            <div class="col-md-4">
                                <form action="update_penjualan.php?id=<?php echo $id_data ?>" method="post">
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <input class="form-control" type="date" id="tanggal" value="<?php echo $tanggal ?>" name="tanggal">
